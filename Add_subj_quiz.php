    ...
    foreach($query->result() as $row){
        ...
        <div class="card p-3 m-2" style="background: #D0ECE7;">
                <div class="card-header bg-white mx-2">
                    <div class="p-3 mx-3">Quiz <b class="px-2">#'.$row->id.'</b>
...
<script src="https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/js/bootstrap.min.js" integrity="sha384-JjSmVgyd0p3pXB1rRibZUAYoIIy6OrQ6VrjIEaFf/nJGzIxFDsf4x0xIM+B07jRM" crossorigin="anonymous"></script>
 ...
 <?php 
                    ...
                    foreach ($data->result() as $row) { ?>
                        <form action="<?php base_url('addsubquiz/view_q') ?>" method="post">
                      <div class="ard-body border bg-white shadow m-2">
                            <div class="custom-control custom-checkbox 
                            align-middle m-4">
                                <input type="checkbox" name="ques[]" value="<?php echo $row->id; ?>" class="custom-control-input align-middle mt-4 p-2" id="customCheck<?php echo $row->id; ?>">
